...
// // for better performance turn off Mipmapping when using NearestFilter
...
gui.add(material.normalScale, 'x', 0, 1, 0.001).name('normalScale X');
gui.add(material.normalScale, 'y', 0, 1, 0.001).name('normalScale Y');
