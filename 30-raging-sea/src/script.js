...
gui.add(waterMaterial.uniforms.uSmallWavesElevation, 'value').min(0).max(0.3).step(0.01).name('uSmallWavesElevation')
gui.add(waterMaterial.uniforms.uSmallWavesFrequency, 'value').min(0).max(10).step(0.01).name('uSmallWavesFrequencyX')
gui.add(waterMaterial.uniforms.uSmallWavesSpeed, 'value').min(0).max(4).step(0.01).name('uSmallWavesSpeed')

gui
    .addColor(parameters, 'depthColor')
    .name('depthColor')
    .onChange(() => {
        waterMaterial.uniforms.uDepthColor.value.set(parameters.depthColor)
    })
gui
    .addColor(parameters, 'surfaceColor')
    .name('surfaceColor')
    .onChange(() => {
