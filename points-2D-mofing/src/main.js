...
import mofingVertexShader from './shaders/vertex.glsl'
import mofingFragmentShader from './shaders/fragment.glsl'
...
class Particle {
	...
	_setMesh() {
		...
		const material = new THREE.RawShaderMaterial({
			vertexShader: mofingVertexShader,
			fragmentShader: mofingFragmentShader,
			uniforms: {
